      ...
      mainPanel(width = 8,
                tabsetPanel(
                  ...
                  tabPanel(
                    ...
                    h5(verbatimTextOutput("model_summary_atsp_automl")),
                    h5(verbatimTextOutput("anova_data_atsp_automl")),
      ...
      mainPanel(width = 8,
                tabsetPanel(
                  ...
                  tabPanel(
                    ...
                    h5(verbatimTextOutput("model_summary_sop_automl")),
                    h5(verbatimTextOutput("anova_data_sop_automl")),
                 ...
                 mainPanel(width = 8, 
                           tabsetPanel(id = "tabs_user",
                                       ...
                                       tabPanel("Results", class = "increase-margin",
                                                ...
                                                h5(verbatimTextOutput("optimal_user")),
                        ...
                        mainPanel(width = 8,
                                  tabsetPanel(id = "tabs_user_automl",
                                              ...
                                              tabPanel(
                                                ...
                                                h5(verbatimTextOutput("model_summary_user_automl")),
                                                h5(verbatimTextOutput("anova_data_user_automl")),
                                                h5(verbatimTextOutput("pks_user_automl")),
                                                h5(verbatimTextOutput("optimal_user_automl")),
